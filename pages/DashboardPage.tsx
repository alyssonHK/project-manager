              ...
              <button
                onClick={async () => {
                  ...
                  try {
                    ...
                    // Adiciona instrução final para o modelo: usar persona e estrutura Markdown solicitada
                    lines.push('\n# CONTEXTO E PERSONA\nAtue como um Gerente de Projetos Sênior preparando um relatório de status semanal. O público-alvo são os stakeholders (gerentes, diretores), que têm pouco tempo e precisam de uma visão clara do progresso, dos riscos e das próximas ações.\n\n# ESTRUTURA DE RESPOSTA REQUERIDA\nGere a resposta EXATAMENTE no formato Markdown abaixo, sem adicionar introduções ou conclusões fora desta estrutura.\n\n## Resumo Executivo (Status Geral)\n- [Crie aqui um parágrafo de 5 a 7 linhas sobre o andamento geral dos projetos. Destaque o principal avanço da semana, o maior ponto de atenção ou risco identificado e o que se espera para a próxima semana.]\n\n## Detalhes por Projeto\n- **Nome do Projeto 1:**\n  - **Status:** [Ex: Em dia, Em risco, Atrasado]\n  - **Ações Críticas / Tarefas Pendentes:** [Liste de 2 a 3 tarefas mais importantes ou que estão bloqueando outras. Priorize as que têm prazo mais próximo.]\n  - **Anotações Relevantes:** [Resuma a principal anotação ou decisão tomada sobre este projeto.]\n- **Nome do Projeto 2:**\n  - **Status:** [Ex: Em dia, Em risco, Atrasado]\n  - **Ações Críticas / Tarefas Pendentes:** [Liste de 2 a 3 tarefas mais importantes.]\n  - **Anotações Relevantes:** [Resuma a principal anotação.]\n- [... continue para os outros projetos]\n\n## Sugestão de E-mail para Stakeholders\n**Assunto:** Atualização Semanal de Projetos - [Inserir Data]\n\n**Corpo:**\nOlá a todos,\n\nSegue o resumo do status dos nossos projetos nesta semana:\n\n[Gere aqui um parágrafo conciso (3-4 frases) baseado no Resumo Executivo, ideal para ser copiado e colado. Use uma linguagem clara, direta e focada em resultados e próximos passos.]\n\nPara mais detalhes, o relatório completo está disponível [ou podemos discutir na nossa próxima reunião].\n\nAtenciosamente,\n[Seu Nome/Nome da Equipe]');
